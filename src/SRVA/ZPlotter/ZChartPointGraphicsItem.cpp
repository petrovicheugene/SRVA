...
ZChartPointGraphicsItem::ZChartPointGraphicsItem(
    ZAbstractPlotterDataManager* dataManager,
...
//======================================================
void ZChartPointGraphicsItem::paint(QPainter* painter,
                                    ...
                                    QWidget* widget)
{
    ...
    QPen pen(QBrush(zv_chartPointOptions->zv_outLineColor),
             zv_chartPointOptions->zv_outLineWidth);
...
//======================================================
void ZChartPointGraphicsItem::zp_applyVisibilityAndPos(
    const ZVisibilityPointF& visibilityPoint,
    ZChartPointOptions* chartPointOptions)
{
    zv_chartPointOptions = chartPointOptions;
    ZVisibilityPointF vPoint = visibilityPoint;
    vPoint.setY(vPoint.y() * (-1)
                / zv_chartPointOptions->zp_rulerScaleValue(Qt::Vertical));
    vPoint.setX(vPoint.x()
                / zv_chartPointOptions->zp_rulerScaleValue(Qt::Horizontal));
